...
class MainTabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let vc3 = UINavigationController(rootViewController: UserNotificationViewController())
        let vc4 = UINavigationController(rootViewController: DirectViewController())
